...
public:
    ...
    // FACING_DIRECTION: 0 = EAST, pi/2 = NORTH, pi = WEST, -pi/2 = SOUTH
    : position(spawn_pos), yaw(facing_direction), pitch(), speed(), velocity()
    {
    ...
    const glm::vec3& getVel() {return velocity;}
