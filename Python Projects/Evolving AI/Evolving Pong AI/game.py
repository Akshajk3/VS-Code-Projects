...
class Game():
    ...
    def __init__(self, window, window_width, window_height):
        ...
        self.right_paddle = Paddle(self.window_width - 10, self.window_height // 2)
    ...
    def _draw_hits(self):
        hits_text = self.SCORE_FONT.render(f"{self.left_hit + self.right_hit}", 1, self.RED)
    ...
    def loop(self):
        ...
        game_info = GameInformation(self.left_hit, self.right_hit, self.left_score, self.right_score)
