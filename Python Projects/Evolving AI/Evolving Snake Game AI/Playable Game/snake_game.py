...
class SnakeGame:
    ...
    def play_step(self):
        ...
        if self._is_collision():
            game_over = True
            return game_over, self.score, self.highscore
    ...
    def _update_ui(self):
        ...
        highScore = font.render("Highscore: " + str(self.highscore), True, GREEN)
...
if __name__ == '__main__':
    ...
    while True:
        game_over, score, highscore = game.play_step()
